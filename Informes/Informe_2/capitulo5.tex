...
%	\subsection{Requerimientos Arquitecturales}
	...
	\begin{figure}[H]
		\begin{center}
			\includegraphics[scale=0.7]{imagenes/Arquitectura.jpg}
			\caption{Diagrama de Arquitectura}
		\end{center}
	\end{figure}	
	
	A continuación se describe el propósito de cada una de las capas definidas:
	\begin{enumerate}
	...
	%	\end{itemize} 
		...
		del servidor de aplicaciones Java EE. Estos se utilizan para generar
	...
	\begin{figure}[H]
		\begin{center}
			\includegraphics[scale=0.5]{imagenes/DescomposicionModular.png}
	...
	\begin{itemize}
		...
		\item \textbf{Manejador de Notificaciones y Alertas:} Se encarga de detectar
		los diferentes eventos ocurridos dentro del sistema que producen algun tipo de
		notificación o alerta y a la vez se preocupa de enviar dichas notificaciones y 
		alertas a los usuarios que corresponde.
		
		\item \textbf{Gestor de Emails:} Proporciona funciones para la creación y envio
		...
		los Jefes de Area y Departamento.
		...
		creación, eliminación y modificación de los proyectos, y la información de estos
		como sus tareas, responsables, avance.

		\item \textbf{Monitor de Avance:} Este componente es el encargado de 
		...
		\item \textbf{Gestor de Tareas de Proyectos:} Este permite agregar, eliminar y
		editar tareas en un proyecto.
