...
INSERT INTO ESTADO_SOLICITUD_CAMBIO (id_estado_solicitud_cambio, nombre_estado_solicitud) VALUES 
(0, 'Enviada'),
(1, 'Analisada'),
(2, 'Aprobada'),
(3, 'Desaprobada'),
...
(15409800, 'Andres Mauricio', 'Plaza', 'Rivera', 'andres.plaza@uv.cl', NULL, NULL),
...
INSERT INTO NOTIFICACION (fecha, mensaje_notificacion, revisada, destinatario)values
(CURRENT_TIMESTAMP,'Notificacion 11', false,16775578),
(CURRENT_TIMESTAMP,'Notificacion 12', false,16775578),
(CURRENT_TIMESTAMP,'Notificacion 13', false,16775578),
(CURRENT_TIMESTAMP,'Notificacion 14', false,16775578),
(CURRENT_TIMESTAMP,'Notificacion 15', false,16775578),
(CURRENT_TIMESTAMP,'Notificacion 16', false,16775578),
(CURRENT_TIMESTAMP,'Notificacion 17', false,16775578),
(CURRENT_TIMESTAMP,'Notificacion 18', false,16775578),
(CURRENT_TIMESTAMP,'Notificacion 19', false,16775578),
(CURRENT_TIMESTAMP,'Notificacion 20', false,16775578);
...
INSERT INTO ROL_PROYECTO values
(1, 'Jefe de Proyecto'),
(2, 'Diseñador'),
(3, 'Desarrollador'),
(4, 'Tester');
...
INSERT INTO solicitud_requerimiento (id_solicitud_req, asunto, codigo_consulta, fecha_envio, fecha_ultima_actualizacion, fecha_vencimiento, mensaje, respuesta, area_responsable, estado_solicitud, prioridad_solicitud, responsable, solicitante, tipo_solicitud) 
VALUES 
(1, 'Enviada y Vencida', 'ABCD' ,'2012-07-09 09:51:23', '2012-07-09 09:51:23', '2012-07-19 09:51:23', 'Mensaje', 'Respuesta', 1, 0, 0, NULL, 11111111, 1),
(2, 'Vencida', 'EFGH', '2012-07-09 09:51:23', '2012-07-09 09:51:23', '2012-07-19 09:51:23', 'Mensaje', 'Respuesta', 1, 6, 0, 22222222, 11111111, 1),
(3, 'Finalizada sin respuesta', 'IJKL', '2012-07-09 09:51:23', '2012-07-09 09:51:23', '2012-07-19 09:51:23', 'Mensaje', 'Respuesta', 1, 7, 0, 22222222, 11111111, 1),
(4, 'Cerrada', 'MNLP', '2012-07-09 09:51:23', '2012-07-09 09:51:23', '2012-07-19 09:51:23', 'Mensaje', 'Respuesta', 1, 8, 0, 22222222, 11111111, 1),
(5, 'Sin fecha vencimiento', 'QRST', '2012-07-09 09:51:23', '2012-07-09 09:51:23', NULL, 'Mensaje', 'Respuesta', 1, 1, 0, 22222222, 11111111, 1);
