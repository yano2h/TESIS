...
public class FuncionarioController implements Serializable {
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(Resources.getValue("bundle", "FuncionarioCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(Resources.getValue("bundle", "FuncionarioUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, Resources.getValue("bundle", "PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(Resources.getValue("bundle", "FuncionarioDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, Resources.getValue("bundle", "PersistenceErrorOccured"));
        }
    }
