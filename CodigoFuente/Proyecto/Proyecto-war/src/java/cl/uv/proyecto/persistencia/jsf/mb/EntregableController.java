...
@ManagedBean(name = "entregableController")
@SessionScoped
public class EntregableController implements Serializable {
    ...
    public Entregable getSelected() {
        if (current == null) {
            current = new Entregable();
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String prepareView() {
        current = (Entregable) getItems().getRowData();
    ...
    @FacesConverter(forClass = Entregable.class)
    public static class EntregableControllerConverter implements Converter {

        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            if (value == null || value.length() == 0) {
                return null;
            }
            EntregableController controller = (EntregableController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "entregableController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Entregable) {
                Entregable o = (Entregable) object;
                return getStringKey(o.getIdEntregable());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + EntregableController.class.getName());
            }
        }
    }
}
